...
export const GetLookupCategoriesDocument = `
    query GetLookupCategories($filter: LookupCategoryFilterInput) {
  lookupCategories(filter: $filter) {
    id
    code
    name
    description
...
export const useGetLookupCategoriesQuery = <
      TData = GetLookupCategoriesQuery,
      TError = unknown
    >(
      variables?: GetLookupCategoriesQueryVariables,
      options?: Omit<UseQueryOptions<GetLookupCategoriesQuery, TError, TData>, 'queryKey'> & { queryKey?: UseQueryOptions<GetLookupCategoriesQuery, TError, TData>['queryKey'] }
    ) => {
    
    return useQuery<GetLookupCategoriesQuery, TError, TData>(
      {
    queryKey: variables === undefined ? ['GetLookupCategories'] : ['GetLookupCategories', variables],
    queryFn: graphqlFetcher<GetLookupCategoriesQuery, GetLookupCategoriesQueryVariables>(GetLookupCategoriesDocument, variables),
    ...options
  }
    )};

useGetLookupCategoriesQuery.getKey = (variables?: GetLookupCategoriesQueryVariables) => variables === undefined ? ['GetLookupCategories'] : ['GetLookupCategories', variables];

export const useInfiniteGetLookupCategoriesQuery = <
      TData = InfiniteData<GetLookupCategoriesQuery>,
      TError = unknown
    >(
      variables: GetLookupCategoriesQueryVariables,
      options: Omit<UseInfiniteQueryOptions<GetLookupCategoriesQuery, TError, TData>, 'queryKey'> & { queryKey?: UseInfiniteQueryOptions<GetLookupCategoriesQuery, TError, TData>['queryKey'] }
    ) => {
    
    return useInfiniteQuery<GetLookupCategoriesQuery, TError, TData>(
      (() => {
    const { queryKey: optionsQueryKey, ...restOptions } = options;
    return {
      queryKey: optionsQueryKey ?? variables === undefined ? ['GetLookupCategories.infinite'] : ['GetLookupCategories.infinite', variables],
      queryFn: (metaData) => graphqlFetcher<GetLookupCategoriesQuery, GetLookupCategoriesQueryVariables>(GetLookupCategoriesDocument, {...variables, ...(metaData.pageParam ?? {})})(),
      ...restOptions
    }
  })()
    )};

useInfiniteGetLookupCategoriesQuery.getKey = (variables?: GetLookupCategoriesQueryVariables) => variables === undefined ? ['GetLookupCategories.infinite'] : ['GetLookupCategories.infinite', variables];


useGetLookupCategoriesQuery.fetcher = (variables?: GetLookupCategoriesQueryVariables, options?: RequestInit['headers']) => graphqlFetcher<GetLookupCategoriesQuery, GetLookupCategoriesQueryVariables>(GetLookupCategoriesDocument, variables, options);

export const GetLookupCategoryDocument = `
    query GetLookupCategory($code: String!) {
  lookupCategory(code: $code) {
    id
    code
    name
    description
...
export const useGetLookupCategoryQuery = <
      TData = GetLookupCategoryQuery,
      TError = unknown
    >(
      variables: GetLookupCategoryQueryVariables,
      options?: Omit<UseQueryOptions<GetLookupCategoryQuery, TError, TData>, 'queryKey'> & { queryKey?: UseQueryOptions<GetLookupCategoryQuery, TError, TData>['queryKey'] }
    ) => {
    
    return useQuery<GetLookupCategoryQuery, TError, TData>(
      {
    queryKey: ['GetLookupCategory', variables],
    queryFn: graphqlFetcher<GetLookupCategoryQuery, GetLookupCategoryQueryVariables>(GetLookupCategoryDocument, variables),
    ...options
  }
    )};

useGetLookupCategoryQuery.getKey = (variables: GetLookupCategoryQueryVariables) => ['GetLookupCategory', variables];

export const useInfiniteGetLookupCategoryQuery = <
      TData = InfiniteData<GetLookupCategoryQuery>,
      TError = unknown
    >(
      variables: GetLookupCategoryQueryVariables,
      options: Omit<UseInfiniteQueryOptions<GetLookupCategoryQuery, TError, TData>, 'queryKey'> & { queryKey?: UseInfiniteQueryOptions<GetLookupCategoryQuery, TError, TData>['queryKey'] }
    ) => {
    
    return useInfiniteQuery<GetLookupCategoryQuery, TError, TData>(
      (() => {
    const { queryKey: optionsQueryKey, ...restOptions } = options;
    return {
      queryKey: optionsQueryKey ?? ['GetLookupCategory.infinite', variables],
      queryFn: (metaData) => graphqlFetcher<GetLookupCategoryQuery, GetLookupCategoryQueryVariables>(GetLookupCategoryDocument, {...variables, ...(metaData.pageParam ?? {})})(),
      ...restOptions
    }
  })()
    )};

useInfiniteGetLookupCategoryQuery.getKey = (variables: GetLookupCategoryQueryVariables) => ['GetLookupCategory.infinite', variables];


useGetLookupCategoryQuery.fetcher = (variables: GetLookupCategoryQueryVariables, options?: RequestInit['headers']) => graphqlFetcher<GetLookupCategoryQuery, GetLookupCategoryQueryVariables>(GetLookupCategoryDocument, variables, options);

export const GetLookupValuesDocument = `
    query GetLookupValues($categoryCode: String!, $includeInactive: Boolean) {
  lookupValues(categoryCode: $categoryCode, includeInactive: $includeInactive) {
    id
    categoryId
    clubId
    code
...
export const useGetLookupValuesQuery = <
      TData = GetLookupValuesQuery,
      TError = unknown
    >(
      variables: GetLookupValuesQueryVariables,
      options?: Omit<UseQueryOptions<GetLookupValuesQuery, TError, TData>, 'queryKey'> & { queryKey?: UseQueryOptions<GetLookupValuesQuery, TError, TData>['queryKey'] }
    ) => {
    
    return useQuery<GetLookupValuesQuery, TError, TData>(
      {
    queryKey: ['GetLookupValues', variables],
    queryFn: graphqlFetcher<GetLookupValuesQuery, GetLookupValuesQueryVariables>(GetLookupValuesDocument, variables),
    ...options
  }
    )};

useGetLookupValuesQuery.getKey = (variables: GetLookupValuesQueryVariables) => ['GetLookupValues', variables];

export const useInfiniteGetLookupValuesQuery = <
      TData = InfiniteData<GetLookupValuesQuery>,
      TError = unknown
    >(
      variables: GetLookupValuesQueryVariables,
      options: Omit<UseInfiniteQueryOptions<GetLookupValuesQuery, TError, TData>, 'queryKey'> & { queryKey?: UseInfiniteQueryOptions<GetLookupValuesQuery, TError, TData>['queryKey'] }
    ) => {
    
    return useInfiniteQuery<GetLookupValuesQuery, TError, TData>(
      (() => {
    const { queryKey: optionsQueryKey, ...restOptions } = options;
    return {
      queryKey: optionsQueryKey ?? ['GetLookupValues.infinite', variables],
      queryFn: (metaData) => graphqlFetcher<GetLookupValuesQuery, GetLookupValuesQueryVariables>(GetLookupValuesDocument, {...variables, ...(metaData.pageParam ?? {})})(),
      ...restOptions
    }
  })()
    )};

useInfiniteGetLookupValuesQuery.getKey = (variables: GetLookupValuesQueryVariables) => ['GetLookupValues.infinite', variables];


useGetLookupValuesQuery.fetcher = (variables: GetLookupValuesQueryVariables, options?: RequestInit['headers']) => graphqlFetcher<GetLookupValuesQuery, GetLookupValuesQueryVariables>(GetLookupValuesDocument, variables, options);

export const GetLookupValueDocument = `
    query GetLookupValue($id: ID!) {
  lookupValue(id: $id) {
    id
    categoryId
    clubId
...
export const useGetLookupValueQuery = <
      TData = GetLookupValueQuery,
      TError = unknown
    >(
      variables: GetLookupValueQueryVariables,
      options?: Omit<UseQueryOptions<GetLookupValueQuery, TError, TData>, 'queryKey'> & { queryKey?: UseQueryOptions<GetLookupValueQuery, TError, TData>['queryKey'] }
    ) => {
    
    return useQuery<GetLookupValueQuery, TError, TData>(
      {
    queryKey: ['GetLookupValue', variables],
    queryFn: graphqlFetcher<GetLookupValueQuery, GetLookupValueQueryVariables>(GetLookupValueDocument, variables),
    ...options
  }
    )};

useGetLookupValueQuery.getKey = (variables: GetLookupValueQueryVariables) => ['GetLookupValue', variables];

export const useInfiniteGetLookupValueQuery = <
      TData = InfiniteData<GetLookupValueQuery>,
      TError = unknown
    >(
      variables: GetLookupValueQueryVariables,
      options: Omit<UseInfiniteQueryOptions<GetLookupValueQuery, TError, TData>, 'queryKey'> & { queryKey?: UseInfiniteQueryOptions<GetLookupValueQuery, TError, TData>['queryKey'] }
    ) => {
    
    return useInfiniteQuery<GetLookupValueQuery, TError, TData>(
      (() => {
    const { queryKey: optionsQueryKey, ...restOptions } = options;
    return {
      queryKey: optionsQueryKey ?? ['GetLookupValue.infinite', variables],
      queryFn: (metaData) => graphqlFetcher<GetLookupValueQuery, GetLookupValueQueryVariables>(GetLookupValueDocument, {...variables, ...(metaData.pageParam ?? {})})(),
      ...restOptions
    }
  })()
    )};

useInfiniteGetLookupValueQuery.getKey = (variables: GetLookupValueQueryVariables) => ['GetLookupValue.infinite', variables];


useGetLookupValueQuery.fetcher = (variables: GetLookupValueQueryVariables, options?: RequestInit['headers']) => graphqlFetcher<GetLookupValueQuery, GetLookupValueQueryVariables>(GetLookupValueDocument, variables, options);
...
export const useCreateLookupValueMutation = <
      TError = unknown,
      TContext = unknown
    >(options?: UseMutationOptions<CreateLookupValueMutation, TError, CreateLookupValueMutationVariables, TContext>) => {
    
    return useMutation<CreateLookupValueMutation, TError, CreateLookupValueMutationVariables, TContext>(
      {
    mutationKey: ['CreateLookupValue'],
    mutationFn: (variables?: CreateLookupValueMutationVariables) => graphqlFetcher<CreateLookupValueMutation, CreateLookupValueMutationVariables>(CreateLookupValueDocument, variables)(),
    ...options
  }
    )};


useCreateLookupValueMutation.fetcher = (variables: CreateLookupValueMutationVariables, options?: RequestInit['headers']) => graphqlFetcher<CreateLookupValueMutation, CreateLookupValueMutationVariables>(CreateLookupValueDocument, variables, options);

export const UpdateLookupValueDocument = `
    mutation UpdateLookupValue($input: UpdateLookupValueInput!) {
...
export const useUpdateLookupValueMutation = <
      TError = unknown,
      TContext = unknown
    >(options?: UseMutationOptions<UpdateLookupValueMutation, TError, UpdateLookupValueMutationVariables, TContext>) => {
    
    return useMutation<UpdateLookupValueMutation, TError, UpdateLookupValueMutationVariables, TContext>(
      {
    mutationKey: ['UpdateLookupValue'],
    mutationFn: (variables?: UpdateLookupValueMutationVariables) => graphqlFetcher<UpdateLookupValueMutation, UpdateLookupValueMutationVariables>(UpdateLookupValueDocument, variables)(),
    ...options
  }
    )};


useUpdateLookupValueMutation.fetcher = (variables: UpdateLookupValueMutationVariables, options?: RequestInit['headers']) => graphqlFetcher<UpdateLookupValueMutation, UpdateLookupValueMutationVariables>(UpdateLookupValueDocument, variables, options);

export const DeleteLookupValueDocument = `
    mutation DeleteLookupValue($id: ID!) {
...
export const useDeleteLookupValueMutation = <
      TError = unknown,
      TContext = unknown
    >(options?: UseMutationOptions<DeleteLookupValueMutation, TError, DeleteLookupValueMutationVariables, TContext>) => {
    
    return useMutation<DeleteLookupValueMutation, TError, DeleteLookupValueMutationVariables, TContext>(
      {
    mutationKey: ['DeleteLookupValue'],
    mutationFn: (variables?: DeleteLookupValueMutationVariables) => graphqlFetcher<DeleteLookupValueMutation, DeleteLookupValueMutationVariables>(DeleteLookupValueDocument, variables)(),
    ...options
  }
    )};


useDeleteLookupValueMutation.fetcher = (variables: DeleteLookupValueMutationVariables, options?: RequestInit['headers']) => graphqlFetcher<DeleteLookupValueMutation, DeleteLookupValueMutationVariables>(DeleteLookupValueDocument, variables, options);

export const AddLookupTranslationDocument = `
    mutation AddLookupTranslation($input: AddLookupTranslationInput!) {
  addLookupTranslation(input: $input) {
    success
    message
    error
    translation {
...
export const useAddLookupTranslationMutation = <
      TError = unknown,
      TContext = unknown
    >(options?: UseMutationOptions<AddLookupTranslationMutation, TError, AddLookupTranslationMutationVariables, TContext>) => {
    
    return useMutation<AddLookupTranslationMutation, TError, AddLookupTranslationMutationVariables, TContext>(
      {
    mutationKey: ['AddLookupTranslation'],
    mutationFn: (variables?: AddLookupTranslationMutationVariables) => graphqlFetcher<AddLookupTranslationMutation, AddLookupTranslationMutationVariables>(AddLookupTranslationDocument, variables)(),
    ...options
  }
    )};


useAddLookupTranslationMutation.fetcher = (variables: AddLookupTranslationMutationVariables, options?: RequestInit['headers']) => graphqlFetcher<AddLookupTranslationMutation, AddLookupTranslationMutationVariables>(AddLookupTranslationDocument, variables, options);

export const DeleteLookupTranslationDocument = `
    mutation DeleteLookupTranslation($id: ID!) {
  deleteLookupTranslation(id: $id) {
    success
    message
    error
  }
...
export const useDeleteLookupTranslationMutation = <
      TError = unknown,
      TContext = unknown
    >(options?: UseMutationOptions<DeleteLookupTranslationMutation, TError, DeleteLookupTranslationMutationVariables, TContext>) => {
    
    return useMutation<DeleteLookupTranslationMutation, TError, DeleteLookupTranslationMutationVariables, TContext>(
      {
    mutationKey: ['DeleteLookupTranslation'],
    mutationFn: (variables?: DeleteLookupTranslationMutationVariables) => graphqlFetcher<DeleteLookupTranslationMutation, DeleteLookupTranslationMutationVariables>(DeleteLookupTranslationDocument, variables)(),
    ...options
  }
    )};


useDeleteLookupTranslationMutation.fetcher = (variables: DeleteLookupTranslationMutationVariables, options?: RequestInit['headers']) => graphqlFetcher<DeleteLookupTranslationMutation, DeleteLookupTranslationMutationVariables>(DeleteLookupTranslationDocument, variables, options);
