...
const initialFeatures: Feature[] = [
  // COMPLETED - Foundation (Built)
  {
    ...
    description: 'Complete member lifecycle management including applications, contracts, renewals, and a powerful searchable directory.',
    status: 'completed',
    votes: 156,
    comments: 24,
    category: 'Membership',
  },
  {
    ...
    description: 'Comprehensive billing with invoices, payments, AR management, and Thai tax compliance built-in.',
    status: 'completed',
    votes: 142,
    comments: 18,
    category: 'Billing',
  ...
  {
    id: '3',
    title: 'Golf Tee Sheet',
    description: 'Visual drag-and-drop tee sheet with caddy and cart management, player assignments, and check-in workflow.',
    status: 'completed',
    votes: 134,
    comments: 21,
    category: 'Golf',
  },
  {
    ...
    description: 'Book courts, rooms, and services with visual calendar, recurring reservations, and conflict detection.',
    status: 'completed',
    votes: 118,
    comments: 15,
    category: 'Booking',
  },
  {
    id: '5',
    title: 'POS & Retail',
    description: 'Full-featured point-of-sale for pro shops with inventory management, barcode scanning, and member charging.',
    status: 'completed',
    votes: 98,
    comments: 12,
    category: 'Retail',
  ...
  // Q3 2026 - Launch
  {
    ...
    description: 'Mobile-first self-service portal for members to book, view statements, update profiles, and manage their membership.',
    status: 'in-progress',
    votes: 89,
    comments: 23,
    category: 'Portal',
  ...
  },
  {
    ...
    description: 'Natural language booking and club assistant. "Book me a tee time tomorrow at 9am" or "Show my outstanding balance."',
    status: 'in-progress',
    votes: 76,
    comments: 19,
    category: 'AI',
  ...
  },
  {
    ...
    description: 'Native mobile apps for members with push notifications, digital member card, and offline access.',
    status: 'in-progress',
    votes: 84,
    comments: 16,
    category: 'Portal',
  ...
  // Q4 2026 - Engagement
  {
    ...
    description: 'AI-powered campaigns for member retention: smart email sequences, push notifications, and personalized offers based on behavior.',
    status: 'planned',
    votes: 68,
    comments: 21,
    category: 'Marketing',
  ...
  },
  {
    ...
    description: 'Send booking confirmations, payment reminders, and club announcements via WhatsApp for higher engagement.',
    status: 'planned',
    votes: 67,
    comments: 14,
  ...
  // 2027 - Intelligence
  {
    ...
    description: 'AI creates and optimizes digital ad campaigns across Google, Facebook, and Instagram to acquire new members.',
    status: 'considering',
    votes: 56,
    comments: 14,
    category: 'Marketing',
  ...
  },
  {
    ...
    description: 'AI identifies churn risk, revenue opportunities, and optimal pricing. Proactive insights for better decisions.',
    status: 'considering',
    votes: 44,
    comments: 9,
    category: 'AI',
  ...
  },
  {
    ...
    description: 'Automatic handicap calculation and syncing with national golf associations (TGA, SGA, MGA, HKGA).',
    status: 'considering',
    votes: 52,
    comments: 15,
    category: 'Golf',
  ...
  },
  {
    ...
    description: 'Full tournament setup with brackets, live scoring, leaderboards, and prize distribution.',
    status: 'considering',
    votes: 48,
    comments: 19,
    category: 'Golf',
  ...
  // 2028 - Ecosystem
  {
    id: '16',
    title: 'Public API',
    description: 'Full REST and GraphQL API for building custom integrations and third-party applications.',
    status: 'considering',
    votes: 31,
    comments: 11,
    category: 'Integrations',
  ...
  },
  {
    ...
    description: 'Pre-built integrations with popular systems: accounting (Xero, QuickBooks), POS, access control, and more.',
    status: 'considering',
    votes: 38,
    comments: 8,
    category: 'Integrations',
  ...
  },
  {
    ...
    description: 'Manage multiple club locations from one dashboard with consolidated reporting and shared member database.',
    status: 'considering',
    votes: 42,
    comments: 7,
    category: 'Membership',
  ...
  },
  {
    ...
    description: 'Fully branded member portal and apps with your club\'s logo, colors, and custom domain.',
    status: 'considering',
    votes: 29,
    comments: 6,
    category: 'Portal',
