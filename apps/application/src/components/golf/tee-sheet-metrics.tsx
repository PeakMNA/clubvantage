...
export function TeeSheetMetrics({
  ...
  const metrics = [
    {
      icon: Calendar,
      iconBgColor: 'bg-gradient-to-br from-blue-100 to-blue-200/50',
    ...
    {
      icon: Users,
      iconBgColor: 'bg-gradient-to-br from-violet-100 to-violet-200/50',
    ...
    {
      icon: CheckCircle,
      iconBgColor: 'bg-gradient-to-br from-emerald-100 to-emerald-200/50',
    ...
    {
      icon: Flag,
      iconBgColor: 'bg-gradient-to-br from-amber-100 to-amber-200/50',
